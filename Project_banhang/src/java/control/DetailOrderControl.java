 ...
 * @author Hi
 */
@WebServlet(name = "DetailOrderControl", urlPatterns = {"/detailOrder"})
public class DetailOrderControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listC = cdao.getCartByOrderId(oid);
        List<Cart> listP = pdao.getCartProducts(listC);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DetailOrderControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
